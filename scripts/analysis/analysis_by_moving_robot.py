...
class nav_cloning_node:
    def __init__(self):
        ...
        self.start_distance_for_reset = 0.3
        self.offset_ang = 0
        self.angle_reset = 1
    ...
    def for_visualization(self):
        line = [str(self.episode), str(self.gazebo_pos_x), str(self.gazebo_pos_y), str(self.robot_move_count)]
    ...
    def loop(self):
        ...
        if self.angle_reset == 0:
            self.start_distance = self.start_distance_for_reset
            ...
            with open(self.path + '/traceable_pos.csv', 'r') as f:
                for row in csv.reader(f):
                    ...
                    if number == self.reset_count:
                        self.x_for_csv = str_x
                        self.y_for_csv = str_y
                ...
                with open(self.path + '/traceable_pos.csv', 'r') as f:
                    for row in csv.reader(f):
                        ...
                        if number == self.reset_count:
                            ...
                            # print("start_distance: " + str(self.start_distance))
                            # print("calc_distance: " + str(self.start_distance_for_reset))
        ...
        # calc
                ...
                if self.angle_reset == 2:
                    if self.reset_count % 7 == 1:
                        ...
                        self.start_distance_for_reset = 0.2
                    elif self.reset_count % 7 == 3:
                        self.start_distance_for_reset = 0.1
